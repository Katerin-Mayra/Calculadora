...
public class Calculadora {
    ...
    public String solve() {
        ...
        do {
            RegularMatch match = new RegularMatch(this.expresion, this.mainregx);
            results = match.match();
            binaryOp(results);
        }
    ...
    private void binaryOp(ArrayList<String> results) {
        for(int i=0; i<results.size();i++){
            RegularMatch powmatch = new RegularMatch(results.get(i),powregx);
            RegularMatch divmatch = new RegularMatch(results.get(i),divregx);
            RegularMatch mulmatch = new RegularMatch(results.get(i),mulregx);
            RegularMatch resmatch = new RegularMatch(results.get(i),resregx);
            RegularMatch summatch = new RegularMatch(results.get(i),sumregx);
